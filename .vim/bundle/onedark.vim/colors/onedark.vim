...
let s:vertsplitNC = s:colors.vertsplitNC
" }}}
...
call s:h("StatusLine", { "fg": s:black, "bg": s:vertsplit }) " status line of current window
call s:h("StatusLineNC", { "fg": s:black, "bg": s:vertsplitNC }) " status lines of not-current windows Note: if this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
